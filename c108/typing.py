...
def validate_param_types(
    *,
    ...
    use @valid_param_types instead. For validating object attributes, use validate_attr_types().
    ...
    💡Examples:
        ...
        >>> from c108.typing import valid_param_types        >>> # Conditional validation (advantage over decorator)
